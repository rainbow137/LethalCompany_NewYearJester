...
namespace NewYearJester.Patches
{
    ...
    internal class JesterPatch
    {
        ...
        public static void JesterStart(JesterAI __instance)
        {
            ...
            if (Plugin.JesterTexture == null || Plugin.JesterClip == null || Plugin.JesterHat == null || Plugin.JesterPopClip == null || Plugin.JesterKillingClip == null || Plugin.JesterScreamingClip == null)
            {
                Plugin.Logger.LogWarning("NewYearJester replacement assets null, returning");
                return;
            }
